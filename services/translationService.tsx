...
const T: Record<SupportedLang, Record<string, string>> = {
  ...
  id: {
    ...
    'incometype.INVESTMENT':'Investasi','incometype.PASSIVE':'Pasif (Aset)','incometype.OTHER':'Lainnya',
    // Expenses
  ...
  en: {
    ...
    'incometype.INVESTMENT':'Investment','incometype.PASSIVE':'Passive (Asset)','incometype.OTHER':'Other',
  ...
  hi: {
    ...
    'incometype.INVESTMENT':'निवेश','incometype.PASSIVE':'निष्क्रिय आय','incometype.OTHER':'अन्य',
  ...
  es: {
    ...
    'incometype.INVESTMENT':'Inversión','incometype.PASSIVE':'Pasivo (Activo)','incometype.OTHER':'Otro',
  ...
  fr: {
    ...
    'incometype.INVESTMENT':'Investissement','incometype.PASSIVE':'Passif (Actif)','incometype.OTHER':'Autre',
  ...
  ru: {
    ...
    'incometype.INVESTMENT':'Инвестиции','incometype.PASSIVE':'Пассивный (Активы)','incometype.OTHER':'Другое',
  ...
  ar: {
    ...
    'incometype.INVESTMENT':'استثمار','incometype.PASSIVE':'سلبي (أصول)','incometype.OTHER':'أخرى',
