...
import { Search, UserCheck, UserX, Shield, Eye, TrendingDown, X, AlertTriangle, RefreshCcw, Loader2, Skull } from 'lucide-react';
...
export default function UserManagement() {
  ...
  const handleResetUser = async (user: User) => {
      if (!confirm(`Hapus SEMUA data transaksi untuk user ${user.username}? Tindakan ini tidak dapat dibatalkan.`)) return;
                            ...
                            {user.role !== 'admin' && (
                                <>
                                    ...
                                    <button 
                                       ...
                                       title="Kill Session (Force Logout)"
                                    >
                                       <Skull size={16} />
                                    </button>
                                    ...
                                    <button 
                                       ...
                                       className={`p-2 rounded-lg transition border ${
                                           user.status === 'active' ? 'text-red-600 hover:bg-red-50 border-red-100' : 'text-green-600 hover:bg-green-50 border-green-100'
                                       }`}
