...
import { getConfig, getAllUsers, getUserData , getApiBaseUrl } from '../../services/mockDb';
              ...
              <div className="bg-white rounded-[3rem] w-full max-w-xl shadow-2xl overflow-hidden flex flex-col border border-white/20">
                  <div className="bg-slate-950 p-10 flex justify-between items-start text-white relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                          ...
                          <p className="text-slate-400 text-sm mt-3 leading-relaxed">Pemeriksaan mendalam jalur komunikasi ke <br/><strong>{getApiBaseUrl().replace('https://', '')}</strong></p>
                      </div>
