              ...
              {renewStep === 1 && (
                <div className="p-8 space-y-6">
                  <div className="bg-brand-50 border border-brand-100 rounded-2xl p-4">
                    ...
                    {getPackageById(renewSub.package_id) && (
                      <p className="text-sm font-bold text-brand-700 mt-1">{formatCurrency(getPackageById(renewSub.package_id)!.price_monthly || 0)} <span className="font-medium text-slate-500">/bulan</span></p>
                    )}
                  </div>
